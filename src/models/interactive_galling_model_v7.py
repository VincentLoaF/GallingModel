"""
Interactive Galling Model V7 - Empirical Gaussian Mixture Transitions with Extended Data

V7 extends V6 by incorporating 25°C (room temperature) data as additional baseline
training data. The 25°C data is mapped to T=160°C (ΔT=0) since both represent
"no galling" conditions, providing ~331 extra baseline transitions.

Architecture is identical to V6:
...
Data: 4 temperatures (25→160, 165, 167.5, 170) mapped to ΔT = (0, 5, 7.5, 10)
...
class InteractiveGallingModelV7(nn.Module):
    """
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("Interactive Galling Model V7 - Empirical Transition Model + 25°C Data")
    print("=" * 70)

    model = InteractiveGallingModelV7()
    ...
    plt.tight_layout()
    plt.savefig('v7_model_test.png', dpi=150)
    print("\nSaved: v7_model_test.png")
