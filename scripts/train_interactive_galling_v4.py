"""
Training Script for Interactive Galling Model V4 - Pure Probabilistic Competition

V4 Key Change: Removed output_noise entirely.
...
4. NO output noise — all variability from competition dynamics
...
Usage:
    ...
    python scripts/train_interactive_galling_v4.py --resume-from-best # Continue from best
    python scripts/train_interactive_galling_v4.py --validate-only    # Only validate
...
from src.models.interactive_galling_model_v4 import InteractiveGallingModelV4
from src.trainers.trainer_interactive_galling import InteractiveGallingTrainer, validate_model


def main():
    parser = argparse.ArgumentParser(description='Train Interactive Galling Model V4')
    ...
    print("=" * 80)
    print("TRAINING INTERACTIVE GALLING MODEL V4 - PURE PROBABILISTIC COMPETITION")
    print("=" * 80)
    print("\nV4 Key Change:")
    print("  NO output noise — all variability from PROBABILISTIC COMPETITION")
    print("  KDE smoothing (0.005) for numerical stability only")
    print("\nV4 Features:")
    ...
    config = {
        ...
        'kde_bandwidth': 0.08,
        'save_dir': 'results/interactive_galling_v4'
    }
    ...
    # ======================================================================
    print("\n" + "-" * 80)
    print("Creating Interactive Galling Model V4...")
    print("-" * 80)

    # V4 Physics parameters - Probabilistic competition, NO output noise
    physics_init = {
        # Growth Physics
        'k_adh': 0.05,
        'alpha_tau': 3.5,
        ...
        # --- V4: Probabilistic Competition Parameters (same as V3) ---
    ...
    if args.validate_only:
        ...
        validate_model(
            ...
            n_simulations=20,
            save_dir='results/interactive_galling_v4/validation',
            device=device
        )
        return
    ...
    # ======================================================================
    print("\n" + "-" * 80)
    print("Training V4 model (likelihood-based)...")
    print("-" * 80)
    ...
    # ======================================================================
    print("\n" + "-" * 80)
    print("Validating trained V4 model...")
    print("-" * 80)
    ...
    fig.suptitle('Interactive Galling Model V4: Predicted vs Observed COF', fontsize=14)
    ...
    # Plot 2: V4-specific - Probabilistic Competition Analysis
    fig, axes = plt.subplots(4, 3, figsize=(15, 14))
    fig.suptitle('V4 Pure Probabilistic Competition Analysis', fontsize=14)
    ...
    # ======================================================================
    print("\n" + "=" * 80)
    print("TRAINING SUMMARY - V4 PURE PROBABILISTIC COMPETITION")
    print("=" * 80)
    ...
    print("  - NO output noise — all variability from PROBABILISTIC COMPETITION")
    print("  - KDE smoothing (0.005) for numerical stability only")
    print("  - Oscillations emerge from discrete competition outcomes:")
